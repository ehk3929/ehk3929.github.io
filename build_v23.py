"""
v2.3 빌드 — 7장 서사 + 모던 미니멀 디자인 + 좌측 sticky 메뉴
- 다크 인디고 액센트
- Pretendard 풀 시스템
...
ASSET_MAP = {
    ...
    'thumb_mdh_full':  '썸네일__AI_취향분석.png',
...
def img_data(key):
    return f"data:image/jpeg;base64,{IMG[key]}"
...
.hero-meta {
  ...
  font-size:13.5px; color:var(--gray); font-weight:500;
}
.hero-meta strong { color:var(--ink); font-weight:700; margin-right:8px; }
.hero-meta a { color:var(--ink); text-decoration:none; font-weight:500; }
...
<main class="main">
  ...
  <section id="about" class="hero">
    ...
    <div class="hero-meta">
      <span><strong>김의현</strong></span>
      <span>28년 B2B 사업개발</span>
      <span>17년 회사 운영 경험</span>
      <span>AI 신제품 7년차</span>
    </div>
  </section>
  ...
  <section class="kpi-section">
    ...
    <div class="kpi-grid">
      ...
      <div class="kpi">
        ...
        <div class="kpi-desc"><strong>누적 고객</strong><br>17년 회사 운영</div>
      </div>
      <div class="kpi">
...
OUT = os.path.join(OUT_DIR, 'portfolio_김의현_v2.3.html')
